...
# Для функции линейного вызова all_data_line_call() время выполнения: 0:00:10.240697
# Для функции многопроцессорного вызова all_data_multi_process() время выполнения: 0:00:03.874615
